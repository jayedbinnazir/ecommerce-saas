...
// errorResponse is the wire shape of every error. It is self-describing so a
// client (or another service) can tell which service failed, on which route,
// and correlate it with logs via request_id.
