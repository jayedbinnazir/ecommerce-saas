...
import (
	...
	cartdomain "github.com/jayedbinnazir/cart-service/internal/cart/domain"
...
// Upstream means a dependency (user-management, product-service, inventory-service)
...
var (
	notFoundErrors = []error{
		sql.ErrNoRows,
		cartdomain.ErrCartNotFound,
		cartdomain.ErrItemNotFound,
	}

	validationErrors = []error{
		cartdomain.ErrInvalidSKU,
		cartdomain.ErrInvalidQuantity,
		cartdomain.ErrNoUpdateFields,
		cartdomain.ErrVariantNotAvailable,
		cartdomain.ErrInsufficientStock,
		cartdomain.ErrCurrencyMismatch,
	}

	upstreamErrors = []error{
		catalog.ErrUpstream,
		availability.ErrUpstream,
	}
)
